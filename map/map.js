...
var iCANVAS_START_Y_POS = 0;
var iCANVAS_HEIGHT = 790;
var iCANVAS_WIDTH = 1580;

var iSPACE_FOR_LABEL = 30;

var iMAP_START_X_POS = iCANVAS_START_X_POS + iSPACE_FOR_LABEL;
var iMAP_START_Y_POS = iCANVAS_START_Y_POS + iSPACE_FOR_LABEL;
var iMAP_HEIGHT = iCANVAS_HEIGHT - (iSPACE_FOR_LABEL * 2);
var iMAP_WIDTH = iCANVAS_WIDTH - (iSPACE_FOR_LABEL * 2);
...
function degreesOfLatitudeToScreenY(iDegreesOfLatitude)
{
	...
	iAdjustedDegreesOfLatitude = (iDegreesOfLatitude * 1) + 90;
...
{
	// Make the value positive, so we can calculate the percentage
	iAdjustedDegreesOfLongitude = (iDegreesOfLongitude * 1) + 180;
